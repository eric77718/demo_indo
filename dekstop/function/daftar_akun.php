...
if ($id_login == '') {
		...
		$konfirmasi_password = md5(htmlspecialchars($_POST['konfirmasi_pass']));
		$email = htmlspecialchars($_POST['email']);
		$no_whatsapp = htmlspecialchars($_POST['no_whatsapp']);
		$bank = htmlspecialchars($_POST['bank']);
		$pemilik_rekening = htmlspecialchars($_POST['pemilik_rekening']);
		$norek = htmlspecialchars($_POST['norek']);
		$refferal = htmlspecialchars($_POST['refferal']);
		$captcha_asli = htmlspecialchars($_POST['captcha_asli']);
